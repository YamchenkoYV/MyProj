...
namespace Functions
{
    unsafe public class NelderMead
    {
        ...
        //
        public void Solve(Func<double[], double> fn, int n, double[] start, double[] xmin,
            ...
            *numres = 0;
            ...
            for (; ; )
            {
                ...
                *icount = *icount + 1;
                ...
                //                    
                //  The simplex construction is complete.(Равносторонний)
                //                    
                    ...
                    *icount = *icount + 1;
                    ...
                    else
                    {
                        ...
                        else if (l == 0)
                        {
                            ...
                            *icount = *icount + 1;
                            //
                            //  Contract the whole simplex.(Reduction)
                            //
                            if (y[ihi] < y2star)
                            {
                                for (j = 0; j < nn; j++)
                                {
                                    ...
                                    y[j] = fn(xmin);
                                    *icount = *icount + 1;   //Прибавление итератора после редукции каждой вершины??
                                }
                                ylo = y[0];
                                ilo = 0;
